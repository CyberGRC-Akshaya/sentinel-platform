...
@app.get("/api/health")
def health():
    return {"status": "ok", "service": "Sentinel Assurance Engine", "version": "0.4.0", "timestamp": datetime.utcnow().isoformat()}
...
{finding_blocks}
<div class='footer'>Generated by Sentinel Assurance Engine v0.4. This output supports assurance review and does not replace qualified professional judgment.</div>
</div>
</body>
</html>"""
