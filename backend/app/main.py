...
@app.get("/api/health")
def health():
    return {"status": "ok", "service": "Sentinel Assurance Engine", "version": "0.9.0", "timestamp": datetime.utcnow().isoformat()}
...
{finding_blocks}
<div class='footer'>Generated by Sentinel Assurance Engine v0.9. This output supports assurance review and does not replace qualified professional judgment.</div>
</div>
</body>
</html>"""
